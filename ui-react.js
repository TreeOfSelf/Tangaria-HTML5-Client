...
class ZWindow {
	constructor(root_node, config, on_event) {
		...
		div.style.cssText = "position: absolute;background-color:black; top: 0px; height: 0px; width: 100%;"
...
class UIWindow extends React.Component {
	...
	render() {
		return e('div', {style: {cssText: 'position: absolute; right: 0; background: #000; font-size: smaller'}},
